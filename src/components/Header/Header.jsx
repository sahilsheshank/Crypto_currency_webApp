      ...
      <div className="flex items-center justify-between py-4">
        ...
        <div className="hidden sm:flex sm:items-center">
          <NavLink to={'/'} className={({isActive})=>{
             return(
            (isActive?"text-gray-800 text-sm font-semibold  mr-4 rounded-xl p-3 bg-purple-400 hover: bg-black border transition-all ease-in-out":"text-gray-800 text-sm font-semibold  mr-4")
             );
          }}>Homepage</NavLink>
          <NavLink to={'/exchanges'} className={({isActive})=>{
             return(
            (isActive?"text-gray-800 text-sm font-semibold  mr-4 rounded-xl p-3 bg-purple-400 hover: bg-black border transition-all ease-in-out":"text-gray-800 text-sm font-semibold  mr-4" )
             );
          }}>Exchanges</NavLink>
          <NavLink to={'/cryptocurrencies'} className={({isActive})=>{
             return(
            (isActive?"text-gray-800 text-sm font-semibold  mr-4 rounded-xl p-3 bg-purple-400 hover: bg-black border transition-all ease-in-out":"text-gray-800 text-sm font-semibold  mr-4" )
             );
          }}>Cryptocurrencies</NavLink>
          <NavLink to={'/cryptoDetails'} className={({isActive})=>{
             return(
            (isActive?"text-gray-800 text-sm font-semibold  mr-4 rounded-xl p-3 bg-purple-400 hover: bg-black border transition-all ease-in-out":"text-gray-800 text-sm font-semibold  mr-4" )
             );
